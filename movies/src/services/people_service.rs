...
impl PeopleService {
    ...
    pub async fn list_people(
        ...
        Ok(people::list_people(&mut conn, limit, offset).await?
            .into_iter()
    ...
    pub async fn create_person(
        ...
        Ok(people::create_person(&mut conn, new_person.into()).await?.into())
    }
    ...
    pub async fn update_person(
        ...
        Ok(people::update_person(&mut conn, person_id, updated.into()).await?.into())
    }
    ...
    pub async fn get_people_by_movie_id(
        ...
        Ok(people::get_people_by_movie_id(&mut conn, movie_id).await?
            .into_iter()
            .map(|p| PersonDto::from(p))
            .collect())
    }
