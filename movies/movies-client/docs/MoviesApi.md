...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**movie_id** | **uuid::Uuid** | ID of the movie to delete | [required] |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**movie_id** | **uuid::Uuid** | ID of the movie to retrieve | [required] |
...
> models::MovieDetail get_movie_details_by_id(movie_id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**movie_id** | **uuid::Uuid** | ID of the movie to retrieve details for | [required] |

### Return type

[**models::MovieDetail**](MovieDetail.md)
...
> Vec<models::Movie> search_movies_by_actor(actor_name, limit, offset)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**actor_name** | **String** | Actor name to search for movies | [required] |
**limit** | **i64** | Max number of movies to return | [required] |
**offset** | **i64** | Pagination offset | [required] |
...
> Vec<models::Movie> search_movies_by_title(title_name, limit, offset)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**title_name** | **String** | Title query string to search for movies | [required] |
**limit** | **i64** | Max number of movies to return | [required] |
**offset** | **i64** | Pagination offset | [required] |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**movie_id** | **uuid::Uuid** | ID of the movie to update | [required] |
**new_movie** | [**NewMovie**](NewMovie.md) |  | [required] |
